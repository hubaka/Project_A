...
//! \date       2017
//!
//! \brief      @ Header file of baby grid implementation
//!
//! @(#)$Id:    $
//!
...
#define BABYGRID_H
//---------------------------------------------------------------------------
#include "sys.h"		// reqd. for data types
#include "igrid.h"		// reqd. for igrid interface class
...
//---------------------------------------------------------------------------
//! @def SimpleGrid_DeleteButton(hGrid,fEnable)
//!
//! @brief Delete the button from the grid
//!
//! @param hGrid The handle of the grid.
//! @param fEnable reserved
//!
...
namespace grid
{
	...
	public:
		...
		//! \return		nothing
		//!
		BabyGrid(HINSTANCE&	hParentInstance	);
		...
		//! \return		nothing
		//!
		virtual void createBabyGrid(HWND hWnd);
	private:
